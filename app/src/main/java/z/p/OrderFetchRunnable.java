...
public class OrderFetchRunnable implements Runnable {
    ...
    private void processOrderResponse(Response response) {
        NetworkEvent networkEvent = new NetworkEvent();
    ...
    @Override
    public void run() {
        Log.i(OrderFetchRunnable.class.getSimpleName(), "检查订单");
        sendRequest();
    }
}
